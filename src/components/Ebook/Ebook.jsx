    ...
    <section className="py-12 sm:py-16 md:py-20 bg-white -mt-50 -mb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <h2 id="discover-ebooks" className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 sm:mb-4 md:mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8 sm:mb-12 md:mb-16">
          {(showAllEbooks ? books : books.slice(0, 4)).map((book, index) => (
            <div 
              key={book.id || index} 
              onClick={() => handleEbookClick(book)}
              className="bg-white border-2 border-blue-200 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer group transform hover:scale-102"
              style={{
                width: '100%',
                maxWidth: '500px',
                height: 'auto',
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-shrink-0">
                  ...
                  {/* Fallback Icon */}
                  <div 
                    className="w-16 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center text-white shadow-sm group-hover:shadow-md transition-shadow duration-300"
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-gray-900 text-lg mb-1 leading-tight group-hover:text-blue-600 transition-colors duration-200" style={{
                    display: '-webkit-box',
                    WebkitLineClamp: 2,
