...
export default function Index() {
  ...
  return (
    <main className="min-h-screen bg-white flex items-center justify-center p-4 lg:p-8">
      ...
      <section className="relative w-full max-w-[1280px] h-[690px] bg-[#131313] text-white overflow-hidden rounded-3xl shadow-2xl">

        {/* Decorative white cutouts - matching Figma exact positions */}
        <div className="absolute left-0 bottom-0 w-[319px] h-[57px] bg-white rounded-tr-[40px]"></div>
        <div className="absolute right-0 top-0 w-[294px] h-[88px] bg-white rounded-bl-[40px]"></div>

        {/* Logo - positioned exactly as in Figma */}
        <img
          src="https://api.builder.io/api/v1/image/assets/TEMP/c4211d5390c24e60cca99f479fa28c0cc4ea7ed5?width=244"
          alt="logo"
          className="absolute left-[7px] top-[8px] w-[122px] h-[122px] object-cover"
        />

        {/* Social icons - positioned exactly as in Figma top-right */}
        <div className="absolute right-[12px] top-[12px] flex items-center gap-4">
          <button aria-label="twitter" className="p-4 rounded-full border border-[#DCDCDC] hover:bg-white/10 transition-colors">
          ...
          <button aria-label="facebook" className="p-4 rounded-full border border-[#DCDCDC] hover:bg-white/10 transition-colors">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button aria-label="instagram" className="p-4 rounded-full border border-[#DCDCDC] hover:bg-white/10 transition-colors">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button aria-label="linkedin" className="p-4 rounded-full border border-[#DCDCDC] hover:bg-white/10 transition-colors">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Navigation columns - positioned on the left side */}
        <div className="absolute left-[40px] top-[180px] flex gap-[120px]">
          {/* Explore column */}
          <div className="w-[107px]">
            <h4 className="text-lg font-semibold font-jakarta mb-4 text-white">Explore</h4>
            <ul className="space-y-2 text-base text-[rgba(255,255,255,0.6)] font-general">
          ...
          {/* Company column */}
          <div className="w-[107px]">
            <h4 className="text-lg font-semibold font-jakarta mb-4 text-white">Company</h4>
            <ul className="space-y-2 text-base text-[rgba(255,255,255,0.6)] font-general">
          ...
          {/* Legal Links column */}
          <div className="w-[107px]">
            <h4 className="text-lg font-semibold font-jakarta mb-4 text-white">Legal Links</h4>
            <ul className="space-y-2 text-base text-[rgba(255,255,255,0.6)] font-general">
        ...
        {/* Request a Demo section - positioned center-right */}
        <div className="absolute left-[720px] top-[110px] w-[373px]">
          {/* Demo badge */}
          <div className="flex items-center gap-3 mb-3">
            <span className="px-4 py-2 rounded-full border border-[rgba(255,255,255,0.3)] text-sm text-[#FFE6A1] bg-white/5 shadow-sm">Demo</span>
          </div>

          {/* Main heading */}
          <h1 className="text-5xl font-jakarta font-bold leading-tight mb-4 text-white">Request a Demo</h1>
          ...
          <form onSubmit={handleSubmit} className="w-full">
            <div className="relative">
              <input
                ...
                className="w-full rounded-full border border-[rgba(255,255,255,0.1)] bg-transparent py-4 px-6 pr-44 text-white placeholder:text-[rgba(255,255,255,0.6)] font-general text-base focus:outline-none focus:border-[rgba(255,255,255,0.3)]"
              />
              <button
                type="submit"
                className="absolute right-1 top-1/2 -translate-y-1/2 bg-[#FCB11F] text-white px-6 py-3 rounded-full font-medium hover:bg-[#E5A21C] transition-colors"
              >
                Get Started
              </button>
            </div>
        ...
        {/* Person image - positioned exactly as in Figma */}
        <div className="absolute left-[534px] top-[287px] w-[746px] h-[403px]">
          <img
            src="https://api.builder.io/api/v1/image/assets/TEMP/7ea5fdf57e20ec0b7a4308d2bc28ec7b89465e49?width=1492"
            alt="person pointing"
        ...
        {/* Back to top button */}
        <button className="absolute left-[40px] top-[472px] flex items-center gap-4 text-white hover:text-[#FFE6A1] transition-colors">
          <span className="text-lg font-general">Back to top</span>
          <div className="flex items-center justify-center w-9 h-9 border border-[rgba(255,255,255,0.4)] rounded-md hover:border-[rgba(255,255,255,0.6)] transition-colors">
        ...
        <div className="absolute left-0 bottom-0 mb-[10px] ml-[10px]">
          <span className="inline-flex items-center px-4 py-2 rounded-full bg-white text-[#141219] text-lg font-jakarta">
            Design by Medro ❤️
          </span>
        </div>
