...
export default function Index() {
  ...
  return (
    <main className="min-h-screen bg-white flex items-center justify-center p-4 lg:p-8">
      ...
      <section className="relative w-full max-w-[1280px] h-[400px] sm:h-[500px] md:h-[600px] lg:h-[690px] bg-[#131313] text-white overflow-hidden rounded-3xl shadow-2xl">
...
<path d="M20.447 20.452h-3.554v-5.569c0-1.328-0.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h0.046c0.477-0.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-0.926-2.063-2.065 0-1.138 0.92-2.063 2.063-2.063 1.14 0 2.064 0.925 2.064 2.063 0 1.139-0.925 2.065-2.064 2.065zM7.119 20.452H3.555V9h3.564v11.452zM22.225 0H1.771C0.792 0 0 0.774 0 1.729v20.542C0 23.227 0.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 0.774 23.2 0 22.225 0z" fill="black"/>
        ...
        <div className="absolute left-[20px] sm:left-[30px] md:left-[35px] lg:left-[40px] top-[120px] sm:top-[150px] md:top-[165px] lg:top-[180px] flex flex-col sm:flex-row gap-[60px] sm:gap-[80px] md:gap-[100px] lg:gap-[120px]">
          {/* Explore column */}
          <div className="w-[80px] sm:w-[90px] md:w-[100px] lg:w-[107px]">
        ...
        <div className="absolute left-[20px] sm:left-[200px] md:left-[400px] lg:left-[720px] top-[80px] sm:top-[95px] md:top-[105px] lg:top-[110px] w-[calc(100%-40px)] sm:w-[300px] md:w-[350px] lg:w-[373px]">
          {/* Demo badge */}
          ...
          <form onSubmit={handleSubmit} className="w-full">
            <div className="relative">
              <input
                ...
                className="w-full rounded-full border border-[rgba(255,255,255,0.1)] bg-transparent py-2 sm:py-3 md:py-4 px-3 sm:px-4 md:px-6 pr-20 sm:pr-32 md:pr-40 lg:pr-44 text-white placeholder:text-[rgba(255,255,255,0.6)] font-general text-sm sm:text-base focus:outline-none focus:border-[rgba(255,255,255,0.3)]"
              />
              <button
                type="submit"
                className="absolute right-1 top-1/2 -translate-y-1/2 bg-[#FCB11F] text-white px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-full font-medium hover:bg-[#E5A21C] transition-colors text-xs sm:text-sm md:text-base"
              >
                Get Started
              </button>
            </div>
        ...
        <div className="absolute left-[20px] sm:left-[200px] md:left-[350px] lg:left-[534px] top-[200px] sm:top-[240px] md:top-[260px] lg:top-[287px] w-[calc(100%-40px)] sm:w-[400px] md:w-[500px] lg:w-[746px] h-[200px] sm:h-[280px] md:h-[350px] lg:h-[403px]">
          <img
            src={footerbabe} 
            alt="person pointing"
        ...
        {/* Back to top button */}
        <button className="absolute left-[20px] sm:left-[30px] md:left-[35px] lg:left-[40px] top-[320px] sm:top-[400px] md:top-[450px] lg:top-[472px] flex items-center gap-2 sm:gap-3 md:gap-4 text-white hover:text-[#FFE6A1] transition-colors">
